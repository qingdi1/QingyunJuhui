...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read Qingyun Juhui Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse Qingyun Juhui Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write Qingyun Juhui Zed remote project registry")]
