(() => {
  ...
  function toggleCodexTheme() {
    ...
    setCodexThemeMode(nextTheme)
      ...
      .catch((error) => {
      console.warn("[Qingyun Juhui Stepwise] Failed to switch Codex theme", error);
      });
  }
  ...
  function statusLine(settings) {
    if (settings.enabled !== true) return "Stepwise 已关闭，请在青云聚汇管理工具里开启。";
  ...
  async function openManager() {
    state.settingsStatus = "正在打开青云聚汇管理工具...";
    renderFloat();
